...
export const saveUser = async (user: User): Promise<UserResponse> => {
  try {
    ...
    const safeUser: SafeDatabaseUser = {
      ...
      selectedBanner: result.selectedBanner,
      streak: result.streak,
      activityLog: result.activityLog,
      pinnedBadge: result.pinnedBadge,
      browserNotif: result.browserNotif,
      emailNotif: result.emailNotif,
      emailFrequency: result.emailFrequency,
      questionsAsked: result.questionsAsked,
      answersGiven: result.answersGiven,
      numUpvotesDownvotes: result.numUpvotesDownvotes,
      mutedTime: result.mutedTime,
