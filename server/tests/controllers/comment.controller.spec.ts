...
describe('POST /addComment', () => {
  ...
  it('should return 500 if question cannot be found', async () => {
    const validQid = new mongoose.Types.ObjectId();
    const validCid = new mongoose.Types.ObjectId();
    const mockReqBody = {
      id: validQid.toString(),
  ...
  it('should return 500 if answer cannot be found', async () => {
    const validAid = new mongoose.Types.ObjectId();
    const validCid = new mongoose.Types.ObjectId();
    const mockReqBody = {
      id: validAid.toString(),
  ...
  it('should return 500 if the user cannot be found', async () => {
    const validAid = new mongoose.Types.ObjectId();
    const validCid = new mongoose.Types.ObjectId();
    const mockReqBody = {
      id: validAid.toString(),
  ...
  it('should return 500 if notif cannot be saved', async () => {
    const validAid = new mongoose.Types.ObjectId();
    const validCid = new mongoose.Types.ObjectId();
    const mockReqBody = {
      id: validAid.toString(),
  ...
  it('should return 500 if there is error populating notif', async () => {
    const validAid = new mongoose.Types.ObjectId();
    const validCid = new mongoose.Types.ObjectId();
    const mockReqBody = {
      id: validAid.toString(),
    ...
    getUserByUsernameSpy.mockResolvedValueOnce(validUser);
    saveNotificationSpy.mockResolvedValueOnce(savedNotif);
    popDocSpy.mockRejectedValue({
      error: 'Error populting doc',
    });
